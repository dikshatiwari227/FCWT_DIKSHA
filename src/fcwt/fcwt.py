...
class MexicanHat(Wavelet):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, parameter1, parameter2, ...):  # Add necessary parameters
        _fcwt.MexicanHat_swiginit(self, _fcwt.new_MexicanHat(parameter1, parameter2, ...))  # Adjust constructor parameters as needed

    def generate(self, *args):
        return _fcwt.MexicanHat_generate(self, *args)

    def getSupport(self, scale):
        return _fcwt.MexicanHat_getSupport(self, scale)

    def getWavelet(self, scale, pwav):
        return _fcwt.MexicanHat_getWavelet(self, scale, pwav)

    # Add any additional methods specific to Mexican Hat wavelet

    __swig_destroy__ = _fcwt.delete_MexicanHat

# Register MexicanHat in _fcwt:
_fcwt.MexicanHat_swigregister(MexicanHat)
